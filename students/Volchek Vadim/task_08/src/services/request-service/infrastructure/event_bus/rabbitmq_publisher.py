"""
RabbitMQ publisher for bug service events.
"""
import json
...
class RabbitMQPublisher:
    def __init__(
        ...
        self.channel.exchange_declare(exchange="bug_events", exchange_type="topic", durable=True)

    def publish_dict(self, event_type: str, payload: Dict[str, Any]) -> None:
        message = {
