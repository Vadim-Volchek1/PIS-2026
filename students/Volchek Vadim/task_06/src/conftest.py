"""
Shared pytest fixtures for task 06 tests.
"""
...
@pytest.fixture
def sample_zone():
    return Zone("HIGH", (4.0, 24.0, 0.0, 0.0))


@pytest.fixture
def sample_group():
    group = Group("TEAM-1", "lead.ivanov")
...
def sample_request(sample_zone):
    return Request("BUG-2026-0001", "qa.petrov", sample_zone)
